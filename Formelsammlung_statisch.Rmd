...
\large
$$\large Corr(x,y) = \frac{Cov(x,y)}{\sigma_x \cdot \sigma_y} = \frac{\frac{\sum_{i=1}^n(x_i - \bar{x})(y_i - \bar{y})}{n-1}}{\sigma_x \cdot \sigma_y} = \frac{\frac{\sum_{i=1}^n(x_i - \bar{x})(y_i - \bar{y})}{n-1}}{\sqrt{\sum_{i=1}^n(x_i - \bar{x})^2 \cdot \sum_{i=1}^n(y_i - \bar{y})^2}} $$
\normalsize
